...
<section class="main-section flex-container-vertical">
    <section class="product_overview_rating_container">
        <div class="product">
            <h1><?php echo getName(18);?></h1>
            <img width=300px height=300px  src="<?php echo getImage(18);?>" alt="protein">
        </div>
        <div class="overview_rating_container">
            <div class="overview">
                <h2>Overview</h2>
                <p><?php echo getOverview(18);?></p>
            </div>
            <div class="rating_container">
                <h2>Rating</h2>
                <div class="rating flex-container-vertical" id="rating"><div id="rating-stars"></div><div class="rating-text"><?php echo getRating(18);?></div></div>
            </div>
        </div>   
    </section>
    <!-- Comments -->
