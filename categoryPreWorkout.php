...
<body class="grid-container">
    ...
    <section>
        <h1>Pre-workout reviews</h1>
        <div class="product-grid">
        <a href="product11.php"><div class="hpadding-1 vpadding-1"><div class="flex-container"><img src="pics/picsIcons/Pre-workout/hyper-fx.jpg" alt="hyper fx pre-workout"></div><div><?php echo getRating(18);?></div></div></a>
        </div>
    </section>
    </section>
